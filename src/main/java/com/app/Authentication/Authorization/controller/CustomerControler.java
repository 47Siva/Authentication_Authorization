...
@Tag(name = "Customer_Controller", description = "Hittable endpoints are welcome after user login")
...
public class CustomerControler {
	...
	public ResponseEntity<?> getAllCustomer(@RequestHeader("Authorization") String auth,
			@RequestHeader HttpHeaders httpHeaders) {
		
		ResponseEntity<?>response = null;
		
//		try {
		response = customerService.getAllCustomer(auth);
